...
namespace kAway2 {
  ...
  void Control::netListInit(int colCount, int cfgGroup, int dynActGroup) {
    itemNet item;
    int c = 1, i = 0, ico;
  ...
  void Control::netListSetState(int cfgGroup, int dynActGroup) {
    itemNet item;
  ...
  void Control::netListGetState(int cfgGroup, int dynActGroup) {
    itemNet item;
    char buff[16];
    int v;
